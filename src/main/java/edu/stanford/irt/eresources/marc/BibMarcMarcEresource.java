...
public class BibMarcMarcEresource extends AbstractMarcEresource {
    ...
    private static class CatalogLinkVersion implements Version {

        private static final String LABEL = "Lane Catalog record";

        private static final String URL_BASE = "http://lmldb.stanford.edu/cgi-bin/Pwebrecon.cgi?BBID=";

        private String url;
        
        private List<Link> links;

        public CatalogLinkVersion(final String controlNumber) {
            this.links = Collections.<Link>singletonList(new Link() {
...
//        versions.add(new CatalogLinkVersion(this.record.getControlNumber()));
