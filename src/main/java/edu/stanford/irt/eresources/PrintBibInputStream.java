...
public class PrintBibInputStream extends BibInputStream {
    ...
    private static final String QUERY = "WITH PRINT_BIBS AS " + "  (SELECT BIB_ID " + "  FROM LMLDB.BIB_INDEX "
            + "  WHERE INDEX_CODE = '2450' " + "  AND DISPLAY_HEADING LIKE '%[print]%' " + "  UNION "
            + "    (SELECT BIB_ID " + "    FROM LMLDB.BIB_INDEX " + "    WHERE INDEX_CODE   = '655H' "
            ...
            + "FROM PRINT_BIBS, " + "  LMLDB.BIB_MASTER, " + "  LMLDB.BIB_MFHD, " + "  LMLDB.MFHD_MASTER "
            ...
            + "AND BIB_MFHD.MFHD_ID              = MFHD_MASTER.MFHD_ID" + " ORDER BY BIB_MFHD.BIB_ID";
