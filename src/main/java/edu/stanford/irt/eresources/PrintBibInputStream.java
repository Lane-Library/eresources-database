...
public class PrintBibInputStream extends BibInputStream {
    ...
    private static final String QUERY =
          ...
          + "  LMLDB.BIB_MFHD, "
          + "  LMLDB.MFHD_MASTER "
          + "WHERE PRINT.BIB_ID                = LMLDB.BIB_MASTER.BIB_ID "
          + "AND BIB_MASTER.SUPPRESS_IN_OPAC  != 'Y' "
          + "AND MFHD_MASTER.SUPPRESS_IN_OPAC != 'Y' "
          + "AND BIB_MFHD.BIB_ID               = BIB_MASTER.BIB_ID "
          + "AND BIB_MFHD.MFHD_ID              = MFHD_MASTER.MFHD_ID "
          + "AND ((( BIB_MASTER.UPDATE_DATE   IS NULL "
          + "AND BIB_MASTER.CREATE_DATE        > ? ) "
          + "OR BIB_MASTER.UPDATE_DATE         > ? ) "
          + "AND (( MFHD_MASTER.UPDATE_DATE   IS NULL "
          + "AND MFHD_MASTER.CREATE_DATE       > ? ) "
          + "OR MFHD_MASTER.UPDATE_DATE        > ? ))";
