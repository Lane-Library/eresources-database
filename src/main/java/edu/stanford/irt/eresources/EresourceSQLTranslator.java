...
public class EresourceSQLTranslator {
    ...
    private static final String INSERT_LINK = "LINK (LINK_ID, VERSION_ID, ERESOURCE_ID, LABEL, URL, INSTRUCTION) VALUES (";
    ...
    private String getInsertLinkSQL(final Link link) {
        StringBuilder sb = new StringBuilder(this.insertInto).append(INSERT_LINK)
                ...
                .append(apostrophize(link.getInstruction())).append(END_PAREN);
        return sb.toString();
    }
