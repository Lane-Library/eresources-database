...
public class JDBCAuthTextAugmentation implements AuthTextAugmentation {

    private static final String AUGMENTATION_FILE = "auth-augmentations.obj";

    private static final int JDBC_FETCH_SIZE = 10_000;

    private static final Logger LOG = LoggerFactory.getLogger(JDBCAuthTextAugmentation.class);
