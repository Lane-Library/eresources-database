...
public class DateParserTest {
    ...
    public final void testParseDate() throws Exception {
        assertEquals("12000000", DateParser.parseDate("1200"));
        ...
        assertEquals("20160000", DateParser.parseDate("2016 foo"));
        assertEquals("20160000", DateParser.parseDate("foo 2016"));
        assertEquals("20160000", DateParser.parseDate("bar 2016 foo"));
        assertEquals("20160000", DateParser.parseDate("2016 2018"));
