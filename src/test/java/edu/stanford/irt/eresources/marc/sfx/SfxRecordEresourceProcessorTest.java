...
public class SfxRecordEresourceProcessorTest {
    ...
    public void setup() {
        ...
        this.sfxRecordEresourceProcessor = new SfxRecordEresourceProcessor(this.eresourceHandler, this.keywordsStrategy,
    ...
    public void testProcess() throws Exception {
        ...
        Record mr1 = new Record(
                Files.readAllBytes(Paths.get("src/test/resources/edu/stanford/irt/eresources/marc/sfx/fake.marc")));
