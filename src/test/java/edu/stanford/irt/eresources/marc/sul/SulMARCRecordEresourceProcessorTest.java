...
public class SulMARCRecordEresourceProcessorTest {
    ...
    public void testProcess() throws Exception {
        ...
        FolioRecord fr1 = new FolioRecord(Files.readAllBytes(
                Paths.get("src/test/resources/edu/stanford/irt/eresources/marc/sul/a10009616-folio.json")));
        FolioRecord fr2 = new FolioRecord(Files.readAllBytes(
                Paths.get("src/test/resources/edu/stanford/irt/eresources/marc/sul/in00000172243-folio.json")));
